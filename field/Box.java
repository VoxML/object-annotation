...
public class Box extends AnnotationComponent {
    ...
    public void updateBoxLocation()
    {
        ...
        for(Box box1 : boxSet) {
            if (box1.bounds != null) {
                if(!(box1.top instanceof lists.FieldList))
                    box1.bounds.y = (int) box1.top.getBounds().getY() - 20;
                //else if (((lists.FieldList) box1.top).getList() != null && ((lists.FieldList) box1.top).getList().size() == 0)
                    ...
                    box1.bounds.y = (int) ((AnnotationComponent) (((lists.FieldList) box1.bottom).getList().getFirst())).getBounds().getY() - 20;
